...
import yolact.data
from yolact.data.config import cfg
...
class TargetEstimator:
    ...
    def get_target_estimation(self, k=10):
        ...
        for cls in all_topk_classes:
            all_topk_classes_name.append(self.idx2name(cls))
        ...
        top_class_name = self.idx2name(mode(all_topk_classes))
