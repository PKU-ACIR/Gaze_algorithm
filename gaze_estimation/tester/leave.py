...
import gaze_estimation.models.model as model
import importlib
import numpy as np
import torch
...
import gaze_estimation.ctools as ctools, gaze_estimation.gtools as gtools
import argparse

def main(train, test):

    # ===============================> Setup <============================
    reader = importlib.import_module("gaze_estimation.reader." + test.reader)
    ...
    dataset = reader.loader(data, 500, num_workers=1, shuffle=True)
