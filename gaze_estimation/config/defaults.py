...
config.face_detector.dlib_model_path = 'data/dlib/shape_predictor_68_face_landmarks.dat'
config.face_detector.mediapipe_max_num_faces = 5

# Gaze estimator
config.gaze_estimator = ConfigNode()
config.gaze_estimator.checkpoint = ''
config.gaze_estimator.camera_params = ''
config.gaze_estimator.normalized_camera_params = 'configs/camera_params/normalized_camera_params_eye.yaml'
config.gaze_estimator.normalized_camera_distance = 0.6
config.gaze_estimator.image_size = [224, 224]

# demo
config.demo = ConfigNode()
config.demo.use_camera = True
config.demo.camera_num = 0
