...
from gaze_estimation.common.face_model import FaceModel
from gaze_estimation.common.face_model_mediapipe import FaceModelMediaPipe
...
def load_config() -> yacs.config.CfgNode:
    ...
    parser.add_argument('--config', default='configs/eth-xgaze.yaml', type=str)
