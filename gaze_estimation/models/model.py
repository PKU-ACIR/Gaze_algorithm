...
import math
import copy
from gaze_estimation.models.resnet import resnet50,resnet18
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(self, src, pos):
        ...
        tmp = self.activation(self.linear1(src))

        src2 = self.linear2(self.dropout(tmp))
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.base_model = resnet50(pretrained=True, maps=maps)
